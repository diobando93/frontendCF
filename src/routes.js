...
const tableMobile = React.lazy(() => import('./views/pages/table/tableMobile'))
const tableElectricity = React.lazy(() => import('./views/pages/table/tableElectricity'))
...
const routes = [
  ...
  { path: '/co2', name: 'CO2 DASHBOARD', component: Co2dashboard },
  { path: '/table', name: 'table', component: Table },
  { path: '/tableMobile', name: 'tableMobile', component: tableMobile },
  { path: '/tableElectricity', name: 'tableElectricity', component: tableElectricity },
